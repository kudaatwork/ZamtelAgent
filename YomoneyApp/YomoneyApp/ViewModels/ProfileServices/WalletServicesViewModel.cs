    ...
    public class WalletServicesViewModel : ViewModelBase
    {
            ...
            set
            {
                ...
                if (ItemSelected == null)
                {
                    ...
                    else if(selectedStore.Title == "My Tasks")
                    {
                        ...
                        string link = "http://192.168.100.172:5001/Mobile/Projects?Id=" + uname;
        ...
        private async Task ExecuteGetStoresCommand()
        {
            ...
            try
            {
                ...
                mnu.Add(new MenuItem { Title = "Loyalty Points", Image= "http://192.168.100.172:5001/Content/Spani/Images/Loyalty.jpg", Section = "Yomoney", ServiceId = 1, SupplierId = "All",TransactionType = 6 });
                mnu.Add(new MenuItem { Title = "My Services",  Image = "http://192.168.100.172:5001/Content/Spani/Images/myServices.jpg", Section = "Yomoney", ServiceId = 11, SupplierId = "All", TransactionType = 1 });
                mnu.Add(new MenuItem { Title = "My Tasks", Image = "http://192.168.100.172:5001/Content/Spani/Images/tasks.png", Section = "Web", ServiceId = 1, SupplierId = "5-0001-0000000", TransactionType = 6, Description = "YoLifestyle" });
                mnu.Add(new MenuItem { Title = "Sign Out", Image = "http://192.168.100.172:5001/Content/Spani/Images/signOut.jpg", Section = "Yomoney", ServiceId = 5, SupplierId = "All", TransactionType = 1 });
