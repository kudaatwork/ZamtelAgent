    ...
    public class WalletServicesViewModel : ViewModelBase
    {
        ...
        private async Task ExecuteGetStoresCommand()
        {
            ...
            try
            {
                ...
                mnu.Add(new MenuItem { Title = "Loyalty Points", Image= "http://192.168.100.150:5000/Content/Spani/Images/Loyalty.jpg", Section = "Yomoney", ServiceId = 1, SupplierId = "All",TransactionType = 6 });
                ...
                mnu.Add(new MenuItem { Title = "My Tasks", Image = "http://192.168.100.150:5000/Content/Spani/Images/tasks.png", Section = "Web", ServiceId = 1, SupplierId = "5-0001-0000000", TransactionType = 6, Description = "YoLifestyle" });
