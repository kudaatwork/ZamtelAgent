    ...
    public class WalletServicesViewModel : ViewModelBase
    {
        ...
        public async Task ExecuteGetStoresCommand()
        {
            ...
            try
            {
                ...
                mnu.Add(new MenuItem { Title = "My Promotions", Image = "http://192.168.100.150:5000/Content/Spani/Images/myServices.jpg", Section = "Promotions", ServiceId = 1, SupplierId = "5-0001-0000000", TransactionType = 6, Description = "My Promotions" });
