...
namespace YomoneyApp
{
	public class ChatViewModel : ViewModelBase
    {
        ...
        public string HostDomain = "http://192.168.100.172:5001";
            ...
            set
            {
                ...
                if (ContactSelected == null)
                {
                    ...
                    try
                    {
                        ...
                        {
                            page.Navigation.PushModalAsync(new WebviewPage("http://192.168.100.172:5001/Mobile/JobProfile?id=" + SelectedContact.Phone.ToString(), "Job Profile", true, null));
        ...
        async void _chatServices_onUnread(object sender, string messages)
        {
            ...
            if (nw.Subtract(contactReceive).TotalMilliseconds > 100)
            {
                ...
                if (nn.Count == 0)
                {
                    ...
                    mn.Avator = "http://192.168.100.172:5001/Content/Spani/Images/avator.jpg";
        ...
        async void _chatServices_onContactsUnread(object sender, string messages)
        {
            ...
            if (nw.Subtract(contactReceive).TotalMilliseconds > 100)
            {
                ...
                if (nn.Count == 0)
                {
                    ...
                    mn.Avator = "http://192.168.100.172:5001/Content/Spani/Images/Contactchat.jpg";
                    List<YoContact> resp = new List<YoContact>();
                    resp.Add(mn);
                    _contacts.ReplaceRange(resp);
                }
        ...
        void _chatServices_onRead(object sender, string messages)
        {
            ...
            foreach (var msg in msgs)
            {
                ...
                if (msg.avatar == null)
                {
                    msg.avatar = "http://192.168.100.172:5001/Content/Administration/images/user.png";
                }
                if (msg.Date.Date.ToUniversalTime() == DateTime.Now.Date.ToUniversalTime())
                {
                    msg.time = msg.Date.ToString("HH:mm");
